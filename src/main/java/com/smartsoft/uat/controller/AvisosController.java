...
import com.smartsoft.uat.business.AvisosBusiness;
import com.smartsoft.uat.controller.view.AvisosView;
...
public class AvisosController implements Serializable{
    ...
    @Inject
    private AvisosBusiness business;
    
    private AvisosView view;                  //declarar clase, por cada controller existe un view* 
    ...
    public void mostrarLista(){
        view.setEntity(null);
        view.setListaEntity(business.obtenerListaAvi());
    }
    
    public void nuevo() {
        view.setEntity(new Avisos());
    ...
    public void editar(Avisos entity) {
        view.setEntity(entity);
        view.setListaEntity(null);
    }

    public void eliminar(Avisos entity) {
