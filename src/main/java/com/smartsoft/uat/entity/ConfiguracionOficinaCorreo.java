...
@NamedQueries({
    ...
    @NamedQuery(name = "ConfiguracionOficinaCorreo.findByParametro", query = "SELECT c FROM ConfiguracionOficinaCorreo c WHERE c.parametro = :parametro"),
...
public class ConfiguracionOficinaCorreo implements Serializable {
    ...
    public String toString() {
        return "com.smartsoft.aguapotable.entity.ConfiguracionOficinaCorreo[ id=" + id + " ]";
    }
